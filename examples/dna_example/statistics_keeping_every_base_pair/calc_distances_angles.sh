...
ls -f1 *.pdb | extract_distances.sh "\" C3'\" i+2 \" C3'\"" > distances_backbone_C3p-C3p_raw.dat
...
ls -f1 *.pdb | extract_distances.sh "\"[0::2]\" \" C3'\" i+5 \" C3'\"" > distances_zigzag_majorgroove_C3p-C3p_raw.dat
ls -f1 *.pdb | extract_distances.sh "\"[1::2]\" \" C3'\" i+3 \" C3'\"" > distances_zigzag_minorgroove_C3p-C3p_raw.dat



# Backbone Angles:
ls -f1 *.pdb | extract_angles.sh "\" C3'\" i+2 \" C3'\" i+4 \" C3'\"" > angles_backbone_C3p-C3p-C3p_raw.dat
...
# "[0::2]" are for odd nucleotides    "[1::2]" are for even nucleotides
...
ls -f1 *.pdb | extract_angles.sh "\"[0::2]\" \" C3'\" i+1 \" C3'\" i+3 \" C3'\"" > angles_basepairs_obtuse_C3p-C3p-C3p_raw.dat
ls -f1 *.pdb | extract_angles.sh "\"[0::2]\" \" C3'\" i+2 \" C3'\" i+3 \" C3'\"" >> angles_basepairs_obtuse_C3p-C3p-C3p_raw.dat
ls -f1 *.pdb | extract_angles.sh "\"[1::2]\" \" C3'\" i-1 \" C3'\" i+1 \" C3'\"" > angles_basepairs_acute_C3p-C3p-C3p_raw.dat
ls -f1 *.pdb | extract_angles.sh "\"[1::2]\" \" C3'\" i+2 \" C3'\" i+1 \" C3'\"" >> angles_basepairs_acute_C3p-C3p-C3p_raw.dat
...
#ls -f1 *.pdb | extract_dihedrals.sh 180 "\" C3'\" i+2 \" C3'\" i+4 \" C3'\" i+6 \" C3'\"" > dihedrals_backbone_C3p-C3p-C3p-C3p_raw.dat
...
ls -f1 *.pdb | extract_dihedrals.sh 180 "\"[0::2]\" \" C3'\" i+1 \" C3'\" i+3 \" C3'\" i+2 \" C3'\"" > dihedrals_basepairs_C3p-C3p-C3p-C3p_raw.dat
ls -f1 *.pdb | extract_dihedrals.sh 180 "\"[1::2]\" \" C3'\" i-1 \" C3'\" i+1 \" C3'\" i+2 \" C3'\"" >> dihedrals_basepairs_C3p-C3p-C3p-C3p_raw.dat


# Optional new addition (2016-3-18): "ZIGZAG" interactions between two
# backbone atoms in one chain, followed by two backbone atoms in the opposite
# chain.  In a coarse-grained model, constraints which effect these
# distances/angles can strongly effect bending rigidity (persistence length).
ls -f1 *.pdb | extract_dihedrals.sh 180 "\"[0::2]\" \" C3'\" i+2 \" C3'\" i+3 \" C3'\" i+5 \" C3'\"" > dihedrals_zigzag_majorgroove_C3p-C3p-C3p-C3p_raw.dat
ls -f1 *.pdb | extract_dihedrals.sh 180 "\"[1::2]\" \" C3'\" i+2 \" C3'\" i+1 \" C3'\" i+3 \" C3'\"" > dihedrals_zigzag_minorgroove_C3p-C3p-C3p-C3p_raw.dat
